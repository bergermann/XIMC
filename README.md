...
For the package to work the XIMC library provided by Standa ([installation](https://files.xisupport.com/Software.en.html), [documentation](https://libximc.xisupport.com/doc-en/index.html)) needs to be installed on your machine.
